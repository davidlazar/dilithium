...
void pack_sig(uint8_t sig[CRYPTO_BYTES], const uint8_t alpha[64], const polyvecl *z, const polyveck *h, const uint8_t salt[BLOCK_SIZE]);
...
int unpack_sig(uint8_t alpha[64], polyvecl *z, polyveck *h, uint8_t salt[BLOCK_SIZE], const uint8_t sig[CRYPTO_BYTES]);
